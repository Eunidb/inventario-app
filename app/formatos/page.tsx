...
export default function FormatosPage() {
  ...
  const [estadoFilter, setEstadoFilter] =
    useState<EstadoTrabajo | "">("");

  const [modalNuevo, setModalNuevo] = useState(false);

  const [trabajoEditar, setTrabajoEditar] =
    useState<TrabajoExpediente | null>(null);

  const [trabajoActivo, setTrabajoActivo] =
    useState<TrabajoExpediente | null>(null);
  ...
  const loadTrabajos = useCallback(async () => {
    ...
    try {
      ...
      setTrabajos(
        (data as unknown as TrabajoExpediente[]) ?? []
      );
  ...
  const handleEliminar = async (
    ...
    if (error) {
      alert(
        "Ocurrió un error al eliminar el expediente."
      );
      return;
    }
          ...
          <div className="flex flex-col xl:flex-row xl:items-end xl:justify-between gap-5 mb-7">
            ...
            <div>
              ...
              <p className="text-slate-500 font-medium mt-2 text-sm">
                Expedientes digitales de mantenimiento
                con formularios administrativos y
                técnicos.
              </p>
            </div>
          ...
          <div className="bg-white p-4 sm:p-5 rounded-3xl border border-slate-200 shadow-sm mb-6 transition-all duration-300">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <select
                ...
                onChange={(e) => {
                  setEstadoFilter(
                    e.target.value as EstadoTrabajo | ""
                  );
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 max-w-[300px]">
                            ...
                            {t.maquina && (
                              <p className="text-xs text-[#014ba0] font-mono truncate mt-1">
                                {t.maquina}
                              </p>
                            )}
