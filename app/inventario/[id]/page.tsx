...
export default function InventarioForm() {
  ...
  async function uploadImagen(e: React.ChangeEvent<HTMLInputElement>) {
    try {
      ...
      const {
        data: { publicUrl },
      } = supabase.storage.from("inventario").getPublicUrl(fileName);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      stock_disponible: isEdit
        ? formData.stock_disponible
    ...
    <div className="min-h-screen bg-[#F0F5FA] p-4 lg:p-10">
      <div className="max-w-5xl mx-auto">
        ...
        <form
          ...
          className="bg-white rounded-3xl shadow-xl shadow-blue-900/5 border border-blue-100 overflow-hidden"
        >
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      stock_total: parseInt(e.target.value) || 0,
                    })
                  }
