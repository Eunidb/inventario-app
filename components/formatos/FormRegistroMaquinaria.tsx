        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 bg-white shrink-0">
          <div className="flex-1 min-w-0">
            <FormHeader
              ...
              subtitulo="Formato 2 · Mantenimiento Industrial"
              Icon={Cog}
              color="orange"
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-5 bg-slate-50/50">
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Field label="No. Serie">  <input value={serie}   onChange={e => setSerie(e.target.value)}   className={inputCls} /></Field>
              <Field label="Fecha">      <input type="date" value={fecha} onChange={e => setFecha(e.target.value)} className={inputCls} /></Field>
              <Field label="Área">       <input value={areaProduccion} onChange={e => setAreaProduccion(e.target.value)} className={inputCls} /></Field>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Field label="Efectuó">  <input value={efectuo} onChange={e => setEfectuo(e.target.value)} className={inputCls} /></Field>
              <Field label="Recibió">  <input value={recibio} onChange={e => setRecibio(e.target.value)} className={inputCls} /></Field>
              <Field label="Aprobó">   <input value={aprobo}  onChange={e => setAprobo(e.target.value)}  className={inputCls} /></Field>
            </div>
          </div>
